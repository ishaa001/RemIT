...
app.get('/accepted_req',auth,async(req,res) => {
    ...
    console.log("---------------------------------------Reached to accept request!! and got proj" + req.app.get('proj'));
    res.redirect("fetch_task")
})
...
app.post('/login', async (req, res) => {
    try {
        ...
        if (isPwdMatch) {
            ...
            res.redirect("accepted_req",proj);
            // (req, res) => {
            //     console.log("Going to send get request with parameters!!");
            //     req.app.set('proj', proj)
            //     return res.redirect("/accept_req");
            // }
        }
        else {
