...
function inviteThroughMail(from,mail,group)
{
    var mailOptions = {
        ...
        html:'<p> In order to be a member of a group, if you want to accept then click on accept button or else click on reject</p><br><form action="" method="POST"><input type="submit" value=</form>'
    }
