...
app.get('/dashboard' , auth ,(req,res) => {
    ...
    console.log("I got cookies: " + req.cookies.jwt + "first name is " + req.user.firstname);
    console.log("I got projects: " + req.project);
    // console.log("I got cookies: " + req.cookies.jwt + "and firstname is " + req.firstname);
    res.render("sidebars",{"projects":req.projects});
    res.render("sidebars");
})

app.post('/create_tasks', auth , (req,res) => {
