...
app.post('/register',async(req,res) => {
    try{
        ...
        if(password === cpwd){
            ...
            res.flash('error',"Passwords are not matching!!");
        }
    }catch(error){
        res.status(400).flash('error',error);
    }
});
...
app.post('/login',async(req,res)=>{
    try{
        ...
        if(isPwdMatch){
            ...
            res.flash('error',"Invalid login details!!");
        }

    }catch(error){
        res.status(400).flash('error',"Invalid login details!!");
    }
});
